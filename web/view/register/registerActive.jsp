...
<div>
    ...
    <hr size="5px" color="red" style="width:50%;float: left">
    <hr size="5px" color="gainsboro" style="width:24%;float: left">
</div>
<div align="center">
    <a href="view/login/login.jsp" style="font-size: 30px">激活成功，点击即可登录</a>
</div>
