    ...
    <script>
        window.onload = function(){
            ...
            document.getElementById("form").onsubmit = function () {
                ...
                if(checkNameTwo()&&checkPhone()&&checkTrueName()){
                    ...
                    //xhttp.open("GET", "/modifyMarchantServlet?nameTwo="+nameTwo+"&phone="+phone+"&trueName="+trueName+"&sex="+sex+"&sign="+sign, true);
                    xhttp.open("post", "/modifyMarchantServlet?",true)
                    ...
                    xhttp.onreadystatechange = function () {
                        if (this.readyState == 4 && this.status == 200) {
                            if (xhttp.responseText == "修改成功") {
                                ...
                                location.href = "/view/marchant/marchantImformation.jsp";
                            } else {
                                alert(xhttp.responseText);
                            }
                        }
        ...
        function checkNameTwo() {
            ...
            if("" == nameTwo){
                ...
                s_twoName.innerHTML="<img width='35' height='25' src='/view/img/gouzi.png'/>";
                flag = true;
            }
            return flag;
        }
        ...
        function checkTrueName() {
            ...
            if(!flag){
                ...
                s_trueName.innerHTML="<img width='35' height='25' src='/view/img/gouzi.png'/>";
            }
            return flag;
        }
...
<div id="mostTop">
    ...
    <a id="quit" href="#" style="color: dodgerblue">退出</a>
</div>
<div id="top">
    <a href="#" id="my">我的淘宝</a>
...
<div>
    <span id="float_right">账户信息修改</span>
</div>
<div id="information">
    <form id="form" method="post" action="#" enctype="multipart/form-data">
        <table style="margin-left: 90px">
            <tr>
                ...
                <td class="left">
                        <input type="text" name="name" id="nameTwo" value="${sessionScope.one.nameTwo}">
                </td>
            ...
            <tr>
                ...
                <td class="headPitcher">
                    <a id="show"><img src="../headPitcher/${sessionScope.one.headPitcher}" id="head" ></a>
            ...
            <tr>
                ...
                <td class="left">
                    <input type="text" name="phone" id="phone" value="${sessionScope.one.phone}">
                </td>
            ...
            <tr>
                ...
                <td class="left">
                    <input type="text" name="trueName" id="trueName" value="${sessionScope.one.name}">
                </td>
            ...
            <tr>
                ...
                <td class="left">
                    <input type="text" name="sian" id="sign" value="${sessionScope.one.sign}">
                </td>
            </tr>
        </table>
        <div>
